package fr.breadclient.breadclient.game;
...
public class MinecraftInfos {
    ...
    public static final VersionType VERSION_TYPE = VersionType.VANILLA;
    ...
    public static final GameType OLL_GAME_TYPE = GameType.V1_13_HIGHER_VANILLA;
